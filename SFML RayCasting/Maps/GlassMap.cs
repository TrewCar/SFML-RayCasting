...
namespace SFML_RayCasting.Maps
{
	internal class GlassMap : MapDef
	{
		protected override void InitObjects()
		{
			...
			VertexObject obj1 = new VertexObject("Name1", new Vector2f(50, 600), new Color(15, 15, 15, 255), 2f, true, 1);
			...
			VertexObject obj2 = new VertexObject("Name1", new Vector2f(50, 250), new Color(15, 15, 15, 255), 2f, true, 1);
			...
			VertexObject obj3 = new VertexObject("Name1", new Vector2f(400, 250), new Color(15, 15, 15, 255), 2f, true, 1);
			...
			VertexObject obj4 = new VertexObject("Name1", new Vector2f(50, 250), new Color(15, 15, 15, 255), 2f, true, 1);
